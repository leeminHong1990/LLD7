...
switches.kbeServerLoginPort = 20302;
// switches.kbeServerIP = "192.168.1.52";
// switches.kbeServerLoginPort = 20333;
switches.kbeServerIP = "192.168.1.11";
switches.kbeServerLoginPort = 20013;
// switches.kbeServerIP = "192.168.1.12";
// switches.kbeServerLoginPort = 20013;
...
if (typeof switchesnin1 === 'undefined' ) {
    ...
    switches.game_list = ['ddz', 'tdhmj','tykddmj','tylsmj','gsjmj','jzmj'];// 尝试性将btn_list 放到
}
else {
