...
ddz_rules.is_pair4 = function (cardsInt, sorted, converted) {
	cardsInt = ddz_rules.convert(cardsInt, sorted, converted);
	return [cardsInt.length === 4 ? collections.sum(cardsInt) === cardsInt[0] * 4 : false, ddz_rules.TYPE_PAIR4, cardsInt[0]];
};
...
ddz_rules.test_with_rule = function (cardsInt, sorted, converted, returnInfo, hasFlower) {
	cardsInt = ddz_rules.convert(cardsInt, sorted, converted);
