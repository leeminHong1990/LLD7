var DDZGameRoomSceneUIManager = UIManagerBase.extend({
	...
	onCreate: function () {
		var initUIClassNameList = ["AudioRecordUI", "HelpUI", "ConfigUI", "GamePlayerInfoUI", "CommunicateUI", "ApplyCloseUI", "GPSUI", "ToastUI","GPSceneUI","ClubInviteUI"];
