...
var DDZGameRoomPrepareUI = UIBase.extend({
	ctor: function () {
		this._super();
		this.resourceFilename = "res/ui/DDZGameRoomPrepareUI.json";
		this.talk_img_num = 0;
	},
	...
	initUI: function () {
        ...
        wxinvite_btn.addTouchEventListener(function (sender, eventType) {
			if (eventType == ccui.Widget.TOUCH_ENDED) {
                ...
                var share_title = cutil.get_share_title(player.curGameRoom,const_val.DouDiZhu);
                let share_desc = cutil.get_share_desc(player.curGameRoom,const_val.DouDiZhu);
