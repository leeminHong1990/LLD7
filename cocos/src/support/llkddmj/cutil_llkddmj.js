...
cutil_llkddmj.isMouseGeneral = function (handTiles, handTilesButKing, kingTilesNum, kingTiles, finalTile) {
	...
	if (cutil_llkddmj.checkIs7Pairs(handTilesButKing, kingTilesNum) === true) {
		...
		var hand7PairsTilesButKing = cutil_llkddmj.classifyKingTiles(hand7PairsTiles, kingTiles)[1];
		if (finalTile === kingTiles[0]) {
			if (cutil_llkddmj.checkIs7Pairs(hand7PairsTilesButKing, kingTilesNum - 2) === true) {
				return true;
			}
		} else {
			if (cutil_llkddmj.checkIs7Pairs(hand7PairsTilesButKing, kingTilesNum - 1) === true) {
				return true;
			}
		}
	}
