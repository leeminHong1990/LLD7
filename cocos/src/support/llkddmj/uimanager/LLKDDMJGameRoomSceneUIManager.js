var LLKDDMJGameRoomSceneUIManager = UIManagerBase.extend({
	...
	onCreate: function () {
		...
		var initUIClassNameList = ["GameRoomInfoUI", "AudioRecordUI", "HelpUI", "GameConfigUI", "GamePlayerInfoUI", "CommunicateUI", "ApplyCloseUI", "GPSUI","GPSceneUI","ClubInviteUI", "ConfirmUI"];
