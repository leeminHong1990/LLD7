...
var GameConfigUI = UIBase.extend({
	...
	adapterLanguage:function(){
		if (cutil.keyConvertLanguaeFilters.indexOf(h1global.curUIMgr.gameType) !== -1) {
			this.gameconfig_panel.getChildByName("language_chx1").setVisible(false);
			this.gameconfig_panel.getChildByName("language_img1").setVisible(false);
			this.gameconfig_panel.getChildByName("language_chx2").setVisible(false);
			this.gameconfig_panel.getChildByName("language_img2").setVisible(false);


			this.gameconfig_panel.getChildByName("effect_slider").y += cc.winSize.height * 0.05;
			this.gameconfig_panel.getChildByName("effect_img").y += cc.winSize.height * 0.05;
			this.gameconfig_panel.getChildByName("music_slider").y += cc.winSize.height * 0.05;
			this.gameconfig_panel.getChildByName("music_img").y += cc.winSize.height * 0.05;
		}
	}
});
