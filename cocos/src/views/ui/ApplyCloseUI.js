...
var ApplyCloseUI = BasicDialogUI.extend({
	...
	initUI:function(){
        ...
        if(player.curGameRoom.player_num == 3){
            this.applyclose_panel.getChildByName("player_info_panel3").setVisible(false);
            // this.applyclose_panel.getChildByName("player_info_panel2").setPositionX(this.applyclose_panel.width*0.5);
        }
        if(player.curGameRoom.player_num == 5){
            this.applyclose_panel.getChildByName("player_info_panel4").setVisible(true);
		}
