...
var ClubRecordUI = UIBase.extend({
    ...
    update_scroll:function (scroll, info_list) {
        ...
        function init_panel_item(itemPanel, itemData, idx) {
            ...
            if(itemData["player_info_list"].length == 4){
                itemPanel.getChildByName("name_label_3").setVisible(true);
                itemPanel.getChildByName("score_label_3").setVisible(true);
                itemPanel.getChildByName("name_label_4").setVisible(false);
                itemPanel.getChildByName("score_label_4").setVisible(false);
            }else if( itemData["player_info_list"].length == 3 ){
                itemPanel.getChildByName("name_label_3").setVisible(false);
                itemPanel.getChildByName("score_label_3").setVisible(false);
                itemPanel.getChildByName("name_label_4").setVisible(false);
                itemPanel.getChildByName("score_label_4").setVisible(false);
            }else{
                itemPanel.getChildByName("name_label_3").setVisible(true);
                itemPanel.getChildByName("score_label_3").setVisible(true);
                itemPanel.getChildByName("name_label_4").setVisible(true);
                itemPanel.getChildByName("score_label_4").setVisible(true);
            }
            //新增的详情按钮
                ...
                detail_btn.addTouchEventListener(function (sender, eventType) {
                    if (eventType === ccui.Widget.TOUCH_ENDED) {
                        ...
                        UICommonWidget.update_scroll_items(self.detail_panel.getChildByName("record_all_scroll"), item_list, function (itemPanel, itemData, idx) {
                            ...
                            if(itemData["player_info_list"].length == 4){
                                itemPanel.getChildByName("player_name_label_3").setVisible(true);
                                itemPanel.getChildByName("player_score_label_3").setVisible(true);
                                itemPanel.getChildByName("player_name_label_4").setVisible(false);
                                itemPanel.getChildByName("player_score_label_4").setVisible(false);
                            }else if( itemData["player_info_list"].length == 3 ){
                                itemPanel.getChildByName("player_name_label_3").setVisible(false);
                                itemPanel.getChildByName("player_score_label_3").setVisible(false);
                                itemPanel.getChildByName("player_name_label_4").setVisible(false);
                                itemPanel.getChildByName("player_score_label_4").setVisible(false);
                            }else{
                                itemPanel.getChildByName("player_name_label_3").setVisible(true);
                                itemPanel.getChildByName("player_score_label_3").setVisible(true);
                                itemPanel.getChildByName("player_name_label_4").setVisible(true);
                                itemPanel.getChildByName("player_score_label_4").setVisible(true);
                            }
