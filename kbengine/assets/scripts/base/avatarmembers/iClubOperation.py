...
class iClubOperation(object):
	...
	def getClubListInfo(self):
		club_info_list = []
		for club_id in self.clubList:
			d, err = x42.ClubStub.getClubDetailInfo(club_id)
	...
	def pushClubEventToClient(self, club_id, event_id, data):
		...
		ID2FUNC = {
			...
			Events.EVENT_CLUB_DAILY_ROUND_CHANGE		: 'clubEvent_CDRC',	# 19
			Events.EVENT_CLUB_DISMISS_ROOM_PLAN_CHANGE	: 'clubEvent_CDRPC',# 20
		}
